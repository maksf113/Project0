...
inline void ShaderProgram::setUniform(const std::string& name, float v0, float v1)
{
	int location = getUniformLocation(name);
	GL(glUniform2f(location, v0, v1));
}

inline void ShaderProgram::setUniform(const std::string& name, float v0, float v1, float v2)
{
	int location = getUniformLocation(name);
	GL(glUniform3f(location, v0, v1, v2));
}

inline void ShaderProgram::setUniform(const std::string& name, float v0, float v1, float v2, float v3)
{
	int location = getUniformLocation(name);
	GL(glUniform4f(location, v0, v1, v2, v3));
}

inline int ShaderProgram::getUniformLocation(const std::string& name)
{
